...
plt.axvline(sredina_sve, color = "red", linestyle = '--', label = "Sredina (sve)")
plt.axvline(medijan_sve, color = "darkgreen", linestyle = ':', label = "Medijan (sve)")

plt.axvline(sredina_bez, color = "cyan", linestyle = '--', label = "Sredina (bez pogrešaka)")
plt.axvline(medijan_bez, color = "yellow", linestyle = ':', label = "Medijan (bez pogrešaka)")
